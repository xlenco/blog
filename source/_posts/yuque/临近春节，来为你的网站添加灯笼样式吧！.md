...
{% raw %}
<divid="my-sandbox"></div><scriptsrc="https://unpkg.com/mini-sandbox@0.3.11"></script><script>newMiniSandbox({ el:'#my-sandbox', files:{'index.html':{ defaultValue:`<!DOCTYPE html>
